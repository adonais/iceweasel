...
static void WriteIniPortable(nsIFile* aProfileDir) {
  ...
  static const char kChrome[] = NS_LINEBREAK "[chrome]" NS_LINEBREAK "uc_url=https://sourceforge.net/projects/libportable/files/Iceweasel/scripts/linux/userchrome.tar.xz/download" NS_LINEBREAK "dl_url=https://sourceforge.net/projects/libportable/files/Iceweasel/scripts/linux/downloadupcheck.tar.xz/download" NS_LINEBREAK "mg_url=https://sourceforge.net/projects/libportable/files/Iceweasel/scripts/linux/mousegestures.tar.xz/download" NS_LINEBREAK "t1_url=https://sourceforge.net/projects/libportable/files/Iceweasel/scripts/linux/auto_activate_tab.tar.xz/download" NS_LINEBREAK "t2_url=https://sourceforge.net/projects/libportable/files/Iceweasel/scripts/linux/right_click_close_tab.tar.xz/download" NS_LINEBREAK "ap_url=https://sourceforge.net/projects/libportable/files/Iceweasel/scripts/linux/addonspage.tar.xz/download" NS_LINEBREAK;
