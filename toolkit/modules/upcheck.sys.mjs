...
export class upcheck {
  ...
  static message_caller(msg, vaule) {
    try {
      let ret = 1;
      if (AppConstants.platform === "win") {
        ...
        const func = lib ? lib.declare('ctype_message_caller', ctypes.default_abi, ctypes.int , ctypes.int , ctypes.int) : null;
        if (func) {
          ret = func(msg, vaule);
        }
      }
      ...
      console.log("upcheck.message_caller failed\n");
    }
  }
