...
iceweasel-tabcompactmode-checkbox =
    .label = Restore the compact mode of the tabbar
...
iceweasel-searchhand-checkbox =
    .label = Restore search handoff feature
iceweasel-taskbartabs-checkbox =
    .label = Hide urlbar TaskbarTabs button
...
iceweasel-searchhand-description = Switch to the urlbar when searching in a new tab.
iceweasel-searchhand-warning1 = We disable it by default, but you can enable it.
...
iceweasel-tabcompactmode-description = Reduce the height of the tabbar and urlbar.
iceweasel-tabcompactmode-warning1 = If you think the tabbar is too high.
iceweasel-taskbartabs-description = The new feature developed by Mozilla is designed to let people disable it.
iceweasel-taskbartabs-warning1 = What's the point of pinning a label to the system taskbar?
...
iceweasel-libportable-chrome-warning1 = User scripts may have compatibility issues. Please actively participate in the open-source community.
...
iceweasel-libportable-download-description = downloadUpcheck integrates Aria2 Rpc, Aria2 Cmd, Thunder, Upcheck downloads.
...
iceweasel-ipv6-checkbox2 =
    .label = Enable IPv6
    .description = Enables Iceweasel to use IPv6 connections.
iceweasel-javascript-checkbox2 =
    .label = Disable Javascript
    .description = JavaScript is an essential component of most webpages.
iceweasel-taskbartabs-checkbox2 =
    .label = Hide urlbar TaskbarTabs button
    .description = The new feature developed by Mozilla is designed to let people disable it.
iceweasel-searchhand-checkbox2 =
    .label = Restore search handoff feature
    .description = Switch to the urlbar when searching in a new tab.
iceweasel-lastclose-checkbox2 =
    .label = Keep last new tab
    .description = Keep the browser open when closing the last tab.
iceweasel-tips-checkbox2 =
    .label = Allow tooltips on tab
    .description = When tab previews are disabled, we also disable tab tooltips.
...
iceweasel-libportable-heading2 =
    .label = libportable features
iceweasel-libportable-upcheck-checkbox2 =
    .label = Enable Iceweasel auto-updates
    .description = Upcheck runs with the browser, checking for updates once every 24 hours without additional overhead.
iceweasel-libportable-ghproxy-checkbox2 =
    .label = Enable gh-proxy acceleration
    .description = gh-proxy speeds up Iceweasel updates and script downloads, recommended for users in China to enable.
iceweasel-libportable-bosskey-checkbox2 =
    .label = Enable BossKey
    .description = Default shortcut: Ctrl+Shift+~. Modify via portable.ini.
iceweasel-libportable-ontabs-checkbox2 =
    .label = Enable tab features
    .description = Ontabs uses automation technology to operate tabs.
iceweasel-libportable-ontabs-checkbox3 =
    .label = Enable tab features
    .description = Operate the tab using the UC script, Requires restart.
...
iceweasel-right-click-recover2 =
    .label = Restore tab when right-clicking on tabbar
iceweasel-libportable-multiline-checkbox2 =
    .label = Enable multiple rows of tabs
    .description = All tabs are visible at once.
iceweasel-libportable-ucaddons-checkbox2 =
    .label = Enable userChrome page management
    .description = Add UC Script Management menu to the Addons page.
iceweasel-libportable-download-checkbox2 =
    .label = Enable downloadUpcheck to take over browser downloads
    .description = downloadUpcheck integrates Aria2 Rpc, Aria2 Cmd, Thunder, Upcheck downloaders.
iceweasel-libportable-ubo-checkbox2 =
    .label = Install ublock origin
    .description = Install ublock-origin extension in your browser, Requires restart.
iceweasel-libportable-chrome-checkbox2 =
    .label = Enable userChrome JS
    .description = Script files install in the background, It will not be installed if you have userchrome.js.
iceweasel-libportable-mousegestures-checkbox2 =
    .label = Enable mouse gestures
    .description = Support Luajit scripts, you can modify the script yourself.

iceweasel-footer2 =
  .label = Useful links
iceweasel-config-link2 =
  .label = Visit the Iceweasel project
iceweasel-open-profile2 =
  .label = Open user profile directory
iceweasel-open-keybord2 =
  .label = Open the keyboard shortcut settings page
...
iceweasel_addons_multiline_description = Unlimited rows of tabs
...
mouse_gestures_previous_page = Previous Page
mouse_gestures_next_page = Next Page
mouse_gestures_known_gesture = Gesture:
mouse_gestures_unknown_gesture = Unknown Gesture:

downloadplusbtn = DownloadPlus
download_enhance_click = Enhanced Download: Click to switch default download tool
reload_download_managers = Reload download managers
reload_download_finish = Loading Upcheck-supported download managers complete. Please select your preferred download tool
download_through_upcheck = Download using Upcheck
download_by_default = Download using default tool
...
copy_link = Copy link
be_copied = Copied
dobule_click_to_copy = Double-click to copy link
save_and_open = Save and open
save_as = Save as
save_to = Save to
this_desktop = Desktop
