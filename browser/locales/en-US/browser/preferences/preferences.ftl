...
iceweasel-ai-checkbox =
    .label = Disable AI-related features
...
iceweasel-ai-description = Local AI may cause a significant increase in CPU and memory usage.
iceweasel-ai-warning1 = Its data usage may infringe on users' privacy.
